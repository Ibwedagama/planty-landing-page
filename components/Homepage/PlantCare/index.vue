<template>
  <section
    class="plant-care py-7 md:grid md:grid-cols-2 md:gap-10 md:py-10 xl:py-20"
  >
    <p
      class="plant-care__subtitle mt-2 mb-4 text-center text-sm md:text-left md:text-lg xl:text-2xl xl:leading-normal"
    >
